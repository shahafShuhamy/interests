...
from programUtils.Logger import Logger
from programUtils.XmlParser import XmlParser as xmlParserClass
import time
...
class Prime():
    ...
    def getNextUpdate(self, primeTable):
        ...
        xmlParser = xmlParserClass()
        # xmlResult = ClientGet(xmlUrl, None)
        value = xmlParser.findTagInString(primeTable, self.nextUpdateTag)
        return value
